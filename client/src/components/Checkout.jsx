...
const Checkout = (props) => {
  ...
  return (
    <div className="bg-white">
      ...
      />
      <div
        className="fixed top-0 right-0 hidden h-full w-1/2 bg-dark-blue lg:block"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
        ...
        >
          ...
          <div className="border-b border-gray-200 py-6 text-left max-w-2xl mx-auto mb-6">
            <Link
              to={"/cart"}
              className="text-sm font-medium text-dark-blue hover:text-light-blue"
            >
            ...
            <div className="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
              ...
              <div className="mt-10">
                ...
                <div>
                  <label
                    htmlFor="firstName"
                    className="block text-md text-md text-gray-700 font-normal mt-6"
                  >
                    First Name
                  </label>
                  <div className="mt-1">
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="block w-full rounded-md shadow-sm outline-light-blue/50 outline-offset-2 focus:border-blue focus:ring-blue sm:text-md p-3"
                ...
                <div>
                  <label
                    htmlFor="lastName"
                    className="mt-6 block text-md text-md text-gray-700 font-normal"
                  >
                    Last Name
                  </label>
                  <div className="mt-1">
                ...
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-3">
                  <div className="sm:col-span-3">
                    <label
                      htmlFor="address"
                      className="block text-md text-md text-gray-700 font-normal"
                    >
                      Address
                    </label>
                    <div className="mt-1">
                      <input
                        ...
                        className="block w-full rounded-md shadow-sm outline-light-blue/50 outline-offset-2 focus:border-blue focus:ring-blue sm:text-md p-2.5"
              ...
              <div className="mt-10 flex justify-end border-t border-gray-200 pt-6">
                <button
                  id="submit"
                  type="submit"
                  className="rounded-md border border-transparent bg-dark-blue py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-light-blue focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2 focus:ring-offset-gray-50"
