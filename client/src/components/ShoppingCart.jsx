...
const ShoppingCart = (props) => {
  ...
  const products = useContext(ProductContext).itemsInCart;
  ...
  const updateCartTotal = (arr) => {
    ...
    const tempTotal = sum + taxEstimate + taxPrice;
  ...
  return (
    <div className="bg-white h-screen">
      <div className="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-dark-blue sm:text-4xl">
          Shopping Cart
        </h1>
        <form
                              ...
                              <div className="py-1">
                                {quantity?.map((quantity, quantityIdx) => (
                                  ...
                                  >
                                    <p
                                      onClick={(e) =>
                                        onChangeCartSelect(e, productIdx)
                                      }
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd className="text-sm font-medium text-gray-900">{`$${taxPrice}.00`}</dd>
              </div>
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
            ...
            <div className="mt-6">
              <Link to="/checkout">
                <button
                  type="submit"
                  className="w-full rounded-md border border-transparent bg-dark-blue py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-light-blue focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2 focus:ring-offset-gray-50"
                >
                  Checkout
                </button>
              </Link>
