...
const OrderSummary = (props) => {
  ...
  const sessionShippingInfo = JSON.parse(
        ...
        <div>
          <div className="mx-auto max-w-2xl py-16 px-4 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
            <div className="lg:col-start-2">
              <h1 className="text-sm font-medium text-blue">
                Payment successful!
              </h1>
              ...
              <p className="mt-2 text-base text-gray-500">
                We appreciate your order! Hang tight while we process it and
                we’ll send you a confirmation very soon!
              </p>

              <dl className="mt-16 text-sm font-medium">
                <dt className="text-gray-900">Tracking number</dt>
                <dd className="mt-2 text-blue">51547878755545848512</dd>
              </dl>
